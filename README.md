...
- [Download the Android APK](https://github.com/BDookie02/Wizards-Only-Fools-Unity-Version/releases/download/unity-version-v0.4.0/WizardsOnlyFools.apk)
- [Download the Windows version](https://github.com/BDookie02/Wizards-Only-Fools-Unity-Version/releases/download/unity-version-v0.4.0/WizardsOnlyFools-Windows-Unity-Version-v0.4.0.zip)
- [View the Unity Version release and testing notes](https://github.com/BDookie02/Wizards-Only-Fools-Unity-Version/releases/tag/unity-version-v0.4.0)
...
The authored survival-world slices now generate React's deterministic 7 x 7 initial terrain region around spawn, including 45 surrounding high-detail chunks plus the center and authored Chicago, swamp, and mountain chunks. This restores the open terrain visible outside the four React-accurate village gates; React's unlimited chunk recentering/streaming is still an open parity item. The desert village at chunk `(4,-4)`, Chicago at chunk `(-3,-3)`, swamp village at chunk `(0,-3)`, and mountain village at chunk `(3,0)` retain their authored layouts and behavior. The desert keeps its exact 17.885722662941443 base height, 55 buildings/villagers, 52 walls, 10 markets, 22 palms, 37 ladders, 41 fences, 15 clotheslines, 94 street props, source road/pad meshes, procedural sand/adobe textures, collision structures, and 55 original 52-frame villager archives. Chicago keeps its exact 21.912045982731858 base height, 35 enterable buildings/operators, four landmarks, 46 animated vehicles, 220 animated pedestrians, intersections, street furniture, Cloud Gate, source-generated facade/sign/ad textures, and original operator sprites in a separately streamed Unity scene. The swamp keeps its exact 2.7529895363497836 base height, water/platform levels, 13 stilt huts/villagers, 17 walkways, four ramps, 28 lily pads, 18 stumps, 36 reed patches, 91 rope segments, 39 bulbs, original 28-frame idle/12-frame yawn/sleep toad animation, exact colliders, and 13 original 52-frame villager archives in its own streamed scene. The mountain keeps its exact 3.364967894227928 base height and 217.54496789422794 summit, source terrain/trail/summit meshes, 1,793 emitted slope-grass tufts, 48 cliff patches, eight summit cabins, three mineshaft huts, four native-controller ladders, waterfall, opening/catwalk/wall/banquet detail, and 11 original 52-frame villager archives in a fourth streamed scene. Quest targeting resolves across all village managers while preserving the base manager's exact 307-NPC contract and exact desert/swamp/mountain town identities.

The current world-quality slice adds player-centered, instanced Breath-of-the-Wild-style pixel grass with 55,766 visible blades and 760 flowers in the verified release view; the exact 600-second React day/night cycle with its procedural sun, eight moon phases, clouds, stars, and terrain tint; the compact compass plus full D-pad Left/keyboard M navigation map; and server-authoritative fast travel to Base, Chicago, Swamp, Desert, Mountain, and Graveyard. Lily Coil now has source-derived tunnel, eye animation, grass, lilies, flowers, fireflies, butterflies, seals, and exterior/inside release captures instead of placeholder geometry. The current automated gate is 345/345 tests over 1,240 baked React outputs plus independently hashed bootstrap/Chicago/swamp/mountain/graveyard/Lily-Coil scene payloads, Windows executable/additive-scene launch, urgent portrait and desktop interaction probes, command-console/inventory/base/desert/swamp/mountain-generic-quest/Darrel-dialog/Spirit-Dragon controller probes, the mountain left-stick ladder probe, the production-path Darrel drink/garden/return/save probe, LAN/villager/audio smoke, and release-player captures. Summit/interior visual comparison, full physical traversal, Lily Coil source-side comparison, and awake physical-controller testing remain open. `Docs\Migration` contains the broader parity inventory and the still-open physical/visual gates.
